...
//             item5TextB.text = ("" + item5num);
      ...
      public void InventoryAdd(string item){
            ...
            if (foundItemName == "item1") {
                ResetAllInventory();
                item1bool = true; //item1num ++;
            }
            else if (foundItemName == "item2") {
                ResetAllInventory();
                item2bool = true; //item2num ++;
                //change projectile prefab to another one
            }
            else if (foundItemName == "item3") {
                ResetAllInventory();
                item3bool = true; //item3num ++;
            }
